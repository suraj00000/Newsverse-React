...
export class News extends Component {
  ...
  async componentDidMount() {
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=ffaf0e05bdd143ce8a9b76014d4a3c6d&page=1&page=1&pageSize=${this.props.pageSize}`;
  ...
  handlePreviouseClick = async () => {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=ffaf0e05bdd143ce8a9b76014d4a3c6d&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
    this.setState({loading:true});
    let data = await fetch(url);
    let pasrsedData = await data.json();
    this.setState({
